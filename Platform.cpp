...
Platform::Platform(const glm::vec3 &pos, const glm::vec3 &size) {
    position = pos;
    this->size = size;
...
void Platform::draw(const glm::mat4 &view, const glm::mat4 &projection) const {
    shader.useProgram();
